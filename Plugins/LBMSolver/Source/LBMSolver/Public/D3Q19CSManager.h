...
public:
	...
	void InitResources(UTextureRenderTargetVolume* VelocityTexture, UTextureRenderTargetVolume* densityTexture, UVolumeTexture* probVolText, FIntVector latticeDims, LbmPrecision lbmPrecision = LbmPrecision::Single);
...
private:
	...
	/* Значения плотности в узлах */
	FTexture3DRHIRef DensityOutputTexture;
	FUnorderedAccessViewRHIRef DensityOutputTexture_UAV;
