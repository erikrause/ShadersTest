...
/// </summary>
class FD3Q19CSCollision : public FGlobalShader
{
public:
	//Declare this class as a global shader
	DECLARE_GLOBAL_SHADER(FD3Q19CSCollision);
	//Tells the engine that this shader uses a structure for its parameters
	SHADER_USE_PARAMETER_STRUCT(FD3Q19CSCollision, FGlobalShader);
	/// <summary>
	...
	BEGIN_SHADER_PARAMETER_STRUCT(FParameters, )
		SHADER_PARAMETER_SRV(FBufferStructured, PorousData)
